...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            await interaction.reply({ content: `Warn ID ${warnId} retiré pour <@${warn.user_id}> (Raison : ${warn.reason}).`, ephemeral: true });
            console.log(`Warn ID ${warnId} retiré par ${interaction.user.tag}`);
        } catch (error) {
            console.error('Erreur unwarn :', error.stack);
